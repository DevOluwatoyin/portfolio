export const tech = [
  ...
  {
    id: 3,
    icon: <i className="devicon-javascript-plain text-color-javascript text-7xl md:text-[150px]"></i>,
    title: 'Javascript',
    style: "shadow-color-javascript"
  },
  {
    id: 4,
    icon: <i className="devicon-react-original text-color-react text-7xl md:text-[150px]"></i>,
    title: 'React',
    style: "shadow-color-react"
  },
  {
    id: 5,
    icon: <i className="devicon-tailwindcss-plain text-color-tailwind text-7xl md:text-[150px]"></i>,
    title: 'Tailwind css',
    style: "shadow-color-tailwind"
  },
  {
    id: 6,
    icon: <i className="devicon-github-original text-color-github text-7xl md:text-[150px]"></i>,
    title: 'Github',
